...
class SaskanEyes(wx.Frame):
    """Combo GUI for Admin, Monitor, Controller, Test GUIs, and more.

    Args:
        (object): wx Frame object

    @DEV:
    - Once more into the breach... this time with pygame!
    - Look at hofin app for pygame examples.

    - Things left to do from last prototype...
    ...
    - Go thru systematically, using both previous Qt and ws code and design
      documents as guides, and translate to pygame for all features.
    ...
    - It is doable to define menus first, but might want to wait until all
      ...
      - Don't know if that last one is still relevant with pygame.
    """
